...
import 'package:opinionguard/utilities/dialogs/error_dialog.dart';
import 'package:opinionguard/utilities/dialogs/password_reset_email_sent_dialog.dart';
...
class _ForgotPasswordViewState extends State<ForgotPasswordView> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthBloc, AuthState>(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Forgot Passwore'),
        ),
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                const Text(
                    'If you forgot your password , simply enter your email and we will send you an email where you can reset the password'),
                TextField(
